...
def main():
    try:
        ...
        if count_1 == 0:
            raise ValueError("Training set has no positive (1) samples. Cannot train model.")
        ...
        print(f"Error: Could not find '{DATA_FILE}'. Please ensure you run tbm_labeler.py first.")
