...
def fetch_binance_futures_data(symbol="BTCUSDT", interval="1h", days=30):
    ...
    while current_start < end_time:
        ...
        try:
            ...
            current_start = last_timestamp + 1  # Next start time is last candle's open time + 1ms
    ...
    # Forward-fill and back-fill, using infer_objects to avoid deprecation warnings
...
def main():
    try:
        ...
        print(f"Dataset successfully built and saved to {output_file} (Total rows: {final_len}).")
