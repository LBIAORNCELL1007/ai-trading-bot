...
def fetch_binance_futures_data(symbol, interval="1h", days=30):
    ...
    # ffill ONLY — bfill propagates future values *backwards* into the past
    # which is a textbook look-ahead leak (López de Prado §3).  Initial NaN
    # rows (before first funding/OI observation) are filled with 0.0 — a
    # neutral prior — instead.  Models trained on bfilled data implicitly
    # "know" the future funding rate at every past bar.
    df["funding_rate"] = (
